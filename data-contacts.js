// ================= 常用联系(新生最常联系) · 贸大新生指南 =================
// 来源: 2026级外语学院辅导员提供(2026年9月); 信息处邮箱/电话来自信息处官方报修指引
// 与院系数据不同: 辅导员提供的内部信息, 均已有确切内容, 无「待补充」
const COMMON_CONTACTS = [
  { name: "外语学院教务(王怡坤老师)", phone: "010-64493208", email: "02926@uibe.edu.cn", location: "诚信楼1229",
    biz: "选课退课、成绩绩点、成绩单、双学位、辅修、培养方案、转专业等教务问题" },
  { name: "信息处(网络与信息平台)", phone: "010-64494228", email: "it203@uibe.edu.cn", location: "计算中心楼一层服务大厅",
    biz: "i惠园信息平台、校园邮箱、校园网问题报修; 密码重置等请到服务大厅(工作日 8:30-11:30 / 13:30-17:00, 电话 64492310)" },
  { name: "2026级外语学院辅导员办公室", phone: "", email: "", location: "诚信楼1207",
    biz: "学生事务(请假、材料、日常问题)" },
];
