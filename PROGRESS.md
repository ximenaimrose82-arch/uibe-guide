...
| **v14** | **全站国风主题:宣纸底+朱砂红+宋体,首页hero重构(官方校徽/校训/引句/数据统计/CTA/功能卡/水墨山),子页面统一纸笺风格** | ✅ 刚上线(0d07260) |
...
- PWA:manifest + sw.js 离线缓存(缓存名 uibe-guide-v14,改版需同步)
